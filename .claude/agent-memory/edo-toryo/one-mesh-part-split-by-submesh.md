...
**⚠ 2026-09-21 追記 — `BodyBelowRoofAt` は「一層目」しか返さない。** 区域侵犯のように
「躯体が線を越えないこと」を解くときは**層を問わず**数える必要があるのに、屋根の最下点で切ると
**二層目の妻壁 `wall C`(0.292m)と柱 `wood`(0.562m)が落ちて**、収めたつもりで越えたまま残った
(施主裁定Bの適用漏れ)。⇒ `EdoBuild.BodyExRoofAt`(材の名で屋根だけ落とす・高さで切らない)を新設。
**何を躯体と数えたかは材の名で指図の欄へ書く**(松江松平 `yagura[].bodyParts`)— 今回の取りこぼしは
「何を躯体と呼ぶか」がどこにも書かれていなかったことが根。
