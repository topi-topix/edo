...
# ⚠ 「いずれも」「どちらも」(=どれも・両方とも)は問いではない — 2026-09-21 に報告が誤って弾かれた。
#   選ばせる形(「いずれか」「どちらが/を/に」)だけを拾う。⛔ 網を広げると、言い切りの報告が書き直しになる。
ASK = re.compile(r"(でしょうか|ですか[?？]|ますか[?？]|どちら(?!も)|いずれか|お決め|ご裁定|ご判断|よろしい)")
