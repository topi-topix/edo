...
【寸法は指図 `docs/Sashizu/okabe_sashizu.json` の `kekkai` が正典】
  ...
  必要な長さ(2026-09-04 時点。開口 `gap` で割ったあとの実長):
    W1 45.190 + 3.636(中門 1.5間で割れる)/ W2 3.636 / W3 5.454 / W4 1.818 /
    W5 20.907(木戸 1.5間は端)/ W6 53.449(木戸 3間は端)/ W7 1.818
  ⚠ **開口(中門・木戸)はこの部材に含まれない。**中門は `Own.Munamon(2.7)`(門口 2.7m ≒ 1.5間)
  が使える。⛔ **木戸の部材はまだ無い** — 別途 部材方へ依頼が要る。
...
# 指図 kekkai の7本を開口で割った実長(2026-09-04 時点)
KEKKAI = [45.190, 3.636, 5.454, 1.818, 20.907, 53.449]
