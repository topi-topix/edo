...
# ⭐ **照葉低木の実測**(2026-09-07 是正後。LOD0 の bbox / 三角数。Unity 座標 W=X H=Y D=Z)
#   Tree_Teiboku_Mid       W 1.774 × H 2.000 × D 1.668   6050 / 3408 / 2264
#   Tree_Teiboku_Mid_02    W 1.866 × H 2.000 × D 1.924   5698 / 3208 / 2120
#   Tree_Teiboku_Mid_03    W 1.658 × H 2.000 × D 1.664   5360 / 3020 / 1972
#   Tree_Teiboku_Small     W 0.982 × H 1.200 × D 1.030   5796 / 3292 / 2228
#   Tree_Teiboku_Small_02  W 1.049 × H 1.200 × D 0.992   5626 / 3188 / 2160
#   Tree_Teiboku_Small_03  W 0.969 × H 1.200 × D 1.099   5608 / 3136 / 2096
#   ・幅/丈 = 0.83〜0.93(指図の狙い 0.95。個体差はそのままにしてある)
#   ・接地面 min Y = 0.0000(6点とも実測)
#   ・孤立した葉の房 **0**(葉のカードの中心 → 最寄りの枝の芯 の最大 0.14m < 房の半寸)
