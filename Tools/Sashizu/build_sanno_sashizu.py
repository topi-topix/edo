...
def main():
    ...
    CAP = {
      ...
      "SANDO": ("<b>二ノ鳥居から前庭の中まで、道の領域の中心線に沿って展開した縦断</b>。段は前庭へ上がる石段だけ。途中の局所の起伏は段を設けず路面の摺り付け(±0.3m)で吸収する — 緩い坂を土のまま置くのが近世の常態で、公道に社が石段を築く典拠は無い(考証方の推奨・ユーザー確認待ち)。⭐ <b>2026-09-07 に否定的証拠が立った</b> — 御宮絵図は男坂・女坂を梯子状の記号で描き分けるのに、<b>参道の帯には梯子が一本も無い</b>【S 記号の不在】。⛔ 採否はユーザー裁定のまま。"),
