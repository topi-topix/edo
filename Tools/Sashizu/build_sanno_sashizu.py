...
def main():
    ...
    CAP = {
      ...
      "NS560": ("<b>左が南・右が北で、西を見る断面</b>。実際に切るのは<b>附属堂 其一</b>1棟のみ"
                "(2026-09-01 是正 — 旧文は観音堂・御供所・本殿を挙げていたが、切断線 x=-560 は"
                "それらより11.9〜23.3m西で、この線上には無かった)。"
                "⚠ 自然地形では平場の西肩が h25.5〜27 しかなく、境内面28.3への均しは<b>この付近で3m級の盛土になる</b>(2026-08-22 測り直し)。"),
      ...
      "NEKIRIMORI": ("<b>左が北西・右が南東で、北東を見る斜め断面</b>。<b>最大切土(北東の小丘 h31.6)と"
                "最大盛土(回廊基壇の北端付近)を1本で通す</b>(2026-09-01 是正 — 旧文『御厩の平場の北東角』は"
                "位置が誤りで、切盛図の実測では回廊基壇の北端付近 u0.83 v14.58 が最大3.4m)。"
                "小丘は3.3m切って28.3へ、盛土側は1:1.5の法面で受ける(社地内に収まる)。2026-08-22 検図の指摘で追加。"),
